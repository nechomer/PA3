...
import ic.semanticCheck.SemanticChecker;
...
//	            }
	        	...
	        	//check files without lib
	        	parser pp;
	        	Symbol result;
	        	ASTNode programNode = null;
	        			
	        	pp = new parser(new Lexer(new FileReader(tempFile)));
	    		result = pp.parse();
				...
				System.out.println("finished checking file" + tempFile + "!\n");
